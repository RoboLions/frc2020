...
//			//1.6889348;
	...
	public static double yawGlobal = 0;
	public static double rollGlobal = 0;
	public static double pitchGlobal = 0;
	...
	PigeonIMU imu = new PigeonIMU(RobotMap.backLeftMotor); //leftIntakeMotor
	...
	*/
	...
	public void getTalonData() {
		leftVelocity = getLeftEncoderVelocityinMetersperSec();
		rightVelocity = getRightEncoderVelocityinMetersperSec();
		leftPosition = getLeftEncoderPositioninMeters();
...
//>>>>>>> parent of b4351bc... ASHEVILLE DAY 0 CHANGES
	...
	public void rawTeleopDrive(double th, double ro) {
		leftMotorFront.set(th);
	}
